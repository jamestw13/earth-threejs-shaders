...
import atmopsherVertexShader from './shaders/atmosphere/vertex.glsl';
...
const atmosphereMaterial = new THREE.ShaderMaterial({
  side: THREE.BackSide,
  transparent: true,
  vertexShader: atmopsherVertexShader,
...
gui.add(sunSpherical, 'theta').min(-Math.PI).max(Math.PI).step(0.01).name('sun theta').onChange(updateSun);
